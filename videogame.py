...
""" this importing item file to the video game file
"""


# Creating a child class
class Video_game_disc (Item):
    """ This a video_game_discs class with its attributes
    """
...
Video_game_disc= pd.DataFrame(data, columns=["Title", "Genre", "duration", "Published_year", "Selling_price", "studios_name", "number_item", "rental_price"])
print(Video_game_disc )
